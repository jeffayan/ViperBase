...
//MARK:- viewWillAppear
    override func viewWillAppear(_ animated: Bool) {
        ...
        menuList = ["PROFILE","MY ORDERS","LOGOUT"]
        menuListImage = [#imageLiteral(resourceName: "user"),#imageLiteral(resourceName: "orders"),#imageLiteral(resourceName: "logout")]
...
extension MenuViewController : UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        let height : CGFloat = indexPath.row == 0 ? 250 : 65
        
        return height*(UIScreen.main.bounds.height/CGFloat(667))
    }
