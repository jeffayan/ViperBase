    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == invoiveTableView {
            ...
            if indexPath.row == 0 {
                ...
                let cell = tableView.dequeueReusableCell(withIdentifier: "DeliveryadderssTableViewCell", for: indexPath) as! DeliveryadderssTableViewCell
...
//        incrementView.layer.cornerRadius = incrementView.frame.size.height/2
    }
}


class DeliveryadderssTableViewCell: UITableViewCell {
    override func awakeFromNib() {
        super.awakeFromNib()
    }
}
