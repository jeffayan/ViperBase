...
class Router {
   ...
   // static let user = UIStoryboard(name: "User", bundle: Bundle.main)
    ...
    class func setWireFrame()->(UIViewController){
        ...
        return retrieveUserData() ? main.instantiateViewController(withIdentifier:  Storyboard.Ids.HomePgaeViewController) : main.instantiateViewController(withIdentifier: Storyboard.Ids.HomePgaeViewController)
    }
